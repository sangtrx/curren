...
def _server():
    ...
    # Advertise the read-only contract to MCP clients; no Curren tool mutates state.
    read_only = ToolAnnotations(read_only_hint=True)

    @server.tool(name="curren_list_active_signals", annotations=read_only)
    ...
    @server.tool(name="curren_get_signal", annotations=read_only)
    ...
    @server.tool(name="curren_get_signal_lifecycle", annotations=read_only)
    ...
    @server.tool(name="curren_get_recent_results", annotations=read_only)
    ...
    @server.tool(name="curren_get_track_record", annotations=read_only)
    ...
    @server.tool(name="curren_verify_signal", annotations=read_only)
