...
@pytest.mark.asyncio
async def test_legacy_terminal_row_without_outcome_record_is_not_a_public_result(tmp_path) -> None:
    ...
    # present this row through the explicit results surface as proof-backed data.
